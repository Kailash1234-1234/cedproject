<?php
namespace Ced\Customer\Block\Adminhtml\Customeredit\Tab;
...
class View extends \Magento\Backend\Block\Template implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
     ...
     * @var string
     */
    protected $_template = 'customer_view.phtml';
    /**
     * View constructor.
    ...
    {
        return __('Custom Attribute Tab');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('grid', $this->getLayout()->createBlock('Ced\Customer\Block\Adminhtml\Grid\Grid', 'grid.view.grid'));
