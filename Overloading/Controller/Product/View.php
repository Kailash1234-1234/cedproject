 ...
 */
namespace Ced\Overloading\Controller\Product;
...
class View extends ProductAction implements HttpGetActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
       ...
       // print_r($product['visible']);
             
        if($product['visible']==0){
            $resultRedirect = $this->resultRedirectFactory->create();
            $this->messageManager->addErrorMessage(__('This product Are not Available on this website.'));
            return $resultRedirect->setPath('');
